...
WebUI.setText(findTestObject('Buat Akun/textbox Email'), 'putri@mailsac.com')

WebUI.setText(findTestObject('Buat Akun/textbox Kata Sandi'), 'putri@U1')
...
WebUI.click(findTestObject('Buat Akun/gender Wanita'))

WebUI.click(findTestObject('Buat Akun/Check Box Newsletter Uniqlo'))

WebUI.click(findTestObject('Buat Akun/Check Box Saya setuju dengan PERSYARATAN PENGGUNAAN dan KEBIJAKAN PRIVASI UNIQLO'))

WebUI.click(findTestObject('Buat Akun/Tombol Daftar'))

'Cannot register because the email address is already used'
WebUI.verifyElementPresent(findTestObject('Buat Akun/Pastikan Anda dapat menerima email dari'), 0)
