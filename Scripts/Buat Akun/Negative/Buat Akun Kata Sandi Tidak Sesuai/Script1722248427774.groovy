...
WebUI.setText(findTestObject('Buat Akun/textbox Kata Sandi'), 'ppp')
...
WebUI.verifyElementPresent(findTestObject('Buat Akun/Null Kata sandi harus terdiri dari ketentuan yang berlaku'), 0)
