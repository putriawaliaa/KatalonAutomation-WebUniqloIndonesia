...
WebUI.setText(findTestObject('Buat Akun/textbox Email'), 'putri@mailsac')
...
WebUI.verifyElementPresent(findTestObject('Buat Akun/Null Mohon masukkan alamat e-mail yang aktif'), 0)
